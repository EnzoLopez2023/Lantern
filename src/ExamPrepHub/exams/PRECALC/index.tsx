// PRECALC prep suite shell — 4-tab UI (Study Guide / Practice / Flashcards /
// Diagnostic) for SC's 11th-grade Pre-Calculus course.
...
const TABS = [
  { id: 'guide',      label: 'Study Guide',  Icon: StudyIcon,       sub: 'Eight sections with analogies, diagrams, and quick-checks' },
...
export default function PRECALCExam({ onBackToHub }: ExamHubNav) {
...
function currentTabHeading(tab: TabId): string {
  switch (tab) {
    case 'guide':      return 'Pre-Calculus';
...
function currentTabSubtitle(tab: TabId): string {
  switch (tab) {
    case 'guide':
      return 'Eight subdomains — functions, polynomials, exponentials, trigonometry, analytic trig, series, vectors, and parametrics — each with worked examples, analogies, diagrams, and a quick-check. This is the final runway before Calculus.';
    case 'practice':
    ...
    case 'diagnostic':
      return 'Subdomain-weighted accuracy from your last Practice answers. Shows where you are strongest and where to focus your remaining study time.';
  }
}
