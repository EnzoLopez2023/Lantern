// ENG2 prep suite shell. Top-tab UI (Study Guide / Practice / Flashcards /
// Sandbox / Diagnostic) for SC's English 2 end-of-course exam.
...
export default function ENG2Exam({ onBackToHub }: ExamHubNav) {
...
function currentTabSubtitle(tab: TabId): string {
  switch (tab) {
    case 'guide':
      return 'Eight subdomains covering reading literary and informational texts, argument and rhetoric, grammar, vocabulary, writing, research, and editing — each with example passages, analogies, diagrams, and a "quick check" at the end so you can verify the ideas landed. Callouts mix Watch For, Why It Matters, Make It Stick, In Plain Words, Try This, Connect, and Coach\'s Notes — read every one. No prior knowledge beyond 9th-grade English assumed.';
    case 'practice':
    ...
    case 'sandbox':
      return 'A timed simulation modeled on the SC EOCEP. Counts down, flags for review, breakdown by subdomain. Your EOCEP counts 20% of your final course grade — practice the time pressure here first.';
    case 'diagnostic':
      return 'Subdomain-weighted accuracy from your last Practice answers, mapped to an estimated readiness number. Tells you if you\'re ready.';
  }
}
