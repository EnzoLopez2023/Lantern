...
// English 2 is single-domain on the SC EOCEP — every question is domain 1,
// so the weighted accuracy is just the domain-1 accuracy.
      ...
      {!hasEnoughData ? (
        <Paper elevation={0} sx={{ p: 3, backgroundColor: CARD_BG, border: `1px solid ${BORDER}`, borderRadius: 2 }}>
          ...
          <Typography sx={{ color: TEXT_PRI, fontSize: '0.92rem', lineHeight: 1.7, mb: 1.5 }}>
            ...
            eight English 2 subdomains gets mapped to an estimated scaled score on a 0–1000 scale (pass = 700).
            The SC EOCEP for English 2 counts <strong>20% of your final course grade</strong>, so treat this
            number seriously.
          </Typography>
          <Typography sx={{ color: TEXT_SEC, fontSize: '0.85rem', lineHeight: 1.6 }}>
            The estimate is intentionally conservative — the real scoring includes question difficulty and
