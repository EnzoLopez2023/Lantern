// Unified search dialog for ENVSCI — searches across glossary, study guide
...
const EXAM_ID = 'ENVSCI';
void EXAM_ID;

const SECTIONS_INDEX: { title: string; keywords: string }[] = [
  { title: 'The Big Picture',                     keywords: 'overview environmental science Earth systems ecology biodiversity human impact climate water energy sustainability policy interconnected' },
  { title: 'Earth Systems and Biogeochemical Cycles', keywords: 'lithosphere hydrosphere atmosphere biosphere geosphere carbon nitrogen water phosphorus cycle biogeochemical rock cycle plate tectonics erosion weathering soil formation' },
  { title: 'Ecology and Ecosystems',              keywords: 'ecosystem biome producer consumer decomposer food web trophic level energy pyramid biomass population community habitat niche predator prey symbiosis succession' },
  { title: 'Biodiversity and Conservation',       keywords: 'biodiversity species richness evenness extinction endangered threatened habitat loss fragmentation invasive species keystone species ecosystem services CITES conservation' },
  { title: 'Human Population and Land Use',       keywords: 'human population growth demographic transition fertility rate mortality carrying capacity urbanization deforestation agriculture monoculture GMO soil erosion desertification' },
  { title: 'Climate Change and the Atmosphere',   keywords: 'greenhouse effect greenhouse gas CO2 methane nitrous oxide global warming temperature climate feedback albedo ocean acidification sea level rise IPCC adaptation mitigation' },
  { title: 'Water Resources',                     keywords: 'freshwater groundwater aquifer surface water watershed runoff irrigation water pollution eutrophication point nonpoint source Clean Water Act desalination water scarcity' },
  { title: 'Energy Resources and Sustainability', keywords: 'fossil fuel coal oil natural gas renewable solar wind hydroelectric nuclear geothermal energy efficiency net energy EROI pollution acid rain environmental impact sustainability circular economy' },
  { title: 'Exam-Day Strategy',                   keywords: 'strategy data graph interpret eliminate time management scenario environmental' },
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth
      ...
      <DialogTitle sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: `1px solid ${BORDER}` }}>
        <Typography sx={{ fontWeight: 700, color: TEXT_PRI }}>Search Environmental Science content</Typography>
