...
// Biology 1 is single-domain on the SC EOCEP — every question is domain 1,
      ...
      {!hasEnoughData ? (
        <Paper elevation={0} sx={{ p: 3, backgroundColor: CARD_BG, border: `1px solid ${BORDER}`, borderRadius: 2 }}>
          ...
          <Typography sx={{ color: TEXT_PRI, fontSize: '0.92rem', lineHeight: 1.7, mb: 1.5 }}>
            ...
            eight Biology 1 subdomains gets mapped to an estimated scaled score on a 0–1000 scale (pass = 700).
            The SC EOCEP for Biology 1 counts <strong>20% of your final course grade</strong>, so treat this
            number seriously.
          </Typography>
