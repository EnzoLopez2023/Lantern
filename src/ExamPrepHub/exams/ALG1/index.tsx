// ALG1 prep suite shell. Top-tab UI (Study Guide / Practice / Flashcards /
// Sandbox / Diagnostic) for SC's Algebra 1 end-of-course exam.
...
export default function ALG1Exam({ onBackToHub }: ExamHubNav) {
...
function currentTabSubtitle(tab: TabId): string {
  switch (tab) {
    case 'guide':
      return 'Eight subdomains, each with worked examples, analogies, diagrams, and a "quick check" at the end so you can verify the ideas landed. Callouts mix Watch For, Why It Matters, Make It Stick, In Plain Words, Try This, Connect, and Coach\'s Notes — read every one. No prior algebra assumed.';
    case 'practice':
